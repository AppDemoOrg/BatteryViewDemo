 ...
 * 电池外框和电池内芯
 */
public class BatteryViewOriginal extends View {
    ...
    public BatteryViewOriginal(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initView();
    }

    public BatteryViewOriginal(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }

    public BatteryViewOriginal(Context context) {
        super(context);
        initView();
    }
