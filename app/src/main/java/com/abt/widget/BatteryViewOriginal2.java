 ...
 * 自定义电池图标最终版
 */
public class BatteryViewOriginal2 extends View {
    ...
    public BatteryViewOriginal2(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    ...
    public BatteryViewOriginal2(Context context) {
        super(context);
        initView();
    }
